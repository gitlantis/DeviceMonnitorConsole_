...
namespace DeviceMonnitorAPI.Migrations
{
    ...
    [Migration("20210705161128_Migration01")]
            ...
            modelBuilder.Entity("DeviceMonnitorAPI.DBModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserGuid = new Guid("0a3aebff-39d6-4b21-bf20-b60f5cd21c11"),
                            CreatedDate = new DateTime(2021, 7, 5, 21, 11, 28, 408, DateTimeKind.Local).AddTicks(2253),
                        ...
                        new
                        {
                            UserGuid = new Guid("80519b78-a205-4a85-9514-92a4f0220b53"),
                            CreatedDate = new DateTime(2021, 7, 5, 21, 11, 28, 408, DateTimeKind.Local).AddTicks(2631),
                            EditedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Admin",
                            IsActive = true,
                            LastName = "User",
