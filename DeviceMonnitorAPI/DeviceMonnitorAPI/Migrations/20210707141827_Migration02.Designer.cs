...
namespace DeviceMonnitorAPI.Migrations
{
    ...
    [Migration("20210707141827_Migration02")]
            ...
            modelBuilder.Entity("DeviceMonnitorAPI.DBModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserGuid = new Guid("1afd9f95-fe90-4c07-a1e5-0b866ad7be6e"),
                            CreatedDate = new DateTime(2021, 7, 7, 19, 18, 26, 753, DateTimeKind.Local).AddTicks(4005),
                        ...
                        new
                        {
                            UserGuid = new Guid("4c3e4d5a-87e3-4e1b-8c2b-ca10dc7ae5c4"),
                            CreatedDate = new DateTime(2021, 7, 7, 19, 18, 26, 753, DateTimeKind.Local).AddTicks(4461),
                            EditedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Admin",
                            IsActive = true,
                            LastName = "User",
