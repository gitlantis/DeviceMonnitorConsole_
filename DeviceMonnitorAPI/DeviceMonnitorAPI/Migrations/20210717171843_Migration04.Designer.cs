...
namespace DeviceMonnitorAPI.Migrations
{
    ...
    [Migration("20210717171843_Migration04")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeviceMonnitorAPI.DBModels.ParamNames", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<string>("NameDomains")
                        .HasColumnType("longtext CHARACTER SET utf8mb4");

                    b.Property<int>("NameIndexes")
                        .HasColumnType("int");
                    ...
                    b.HasKey("Id")
                        .HasName("PK_ParamNames");

                    b.HasIndex("Id")
                        .IsUnique();

                    b.ToTable("ParamNames");
                });
            ...
            modelBuilder.Entity("DeviceMonnitorAPI.DBModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserGuid = new Guid("8b89bb24-0648-4c51-9ae7-76a59ad5e39b"),
                            CreatedDate = new DateTime(2021, 7, 17, 22, 18, 43, 35, DateTimeKind.Local).AddTicks(4957),
                        ...
                        new
                        {
                            UserGuid = new Guid("8554ee2b-e60d-40a5-9751-80dc26a9a5dd"),
                            CreatedDate = new DateTime(2021, 7, 17, 22, 18, 43, 35, DateTimeKind.Local).AddTicks(5363),
                            EditedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Admin",
                            IsActive = true,
                            LastName = "User",
            ...
            modelBuilder.Entity("DeviceParamNames", b =>
                {
            ...
            modelBuilder.Entity("DeviceParamNames", b =>
                {
                    ...
                    b.HasOne("DeviceMonnitorAPI.DBModels.ParamNames", null)
                        .WithMany()
