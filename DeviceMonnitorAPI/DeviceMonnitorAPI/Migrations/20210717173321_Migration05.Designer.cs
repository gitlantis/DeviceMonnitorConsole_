...
namespace DeviceMonnitorAPI.Migrations
{
    ...
    [Migration("20210717173321_Migration05")]
            ...
            modelBuilder.Entity("DeviceMonnitorAPI.DBModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserGuid = new Guid("3a570eb7-0918-4712-9e5a-6d21e70759f0"),
                            CreatedDate = new DateTime(2021, 7, 17, 22, 33, 20, 798, DateTimeKind.Local).AddTicks(1969),
                        ...
                        new
                        {
                            UserGuid = new Guid("0ffd55c9-271b-46fe-99fc-46a3ea8ecec9"),
                            CreatedDate = new DateTime(2021, 7, 17, 22, 33, 20, 798, DateTimeKind.Local).AddTicks(2354),
                            EditedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Admin",
                            IsActive = true,
                            LastName = "User",
