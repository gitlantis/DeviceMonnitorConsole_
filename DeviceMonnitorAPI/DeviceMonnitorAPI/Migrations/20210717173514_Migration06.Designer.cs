...
namespace DeviceMonnitorAPI.Migrations
{
    ...
    [Migration("20210717173514_Migration06")]
            ...
            modelBuilder.Entity("DeviceMonnitorAPI.DBModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserGuid = new Guid("cb36cbe9-5ac3-46a6-9327-09bfbe741f95"),
                            CreatedDate = new DateTime(2021, 7, 17, 22, 35, 13, 623, DateTimeKind.Local).AddTicks(2117),
                        ...
                        new
                        {
                            UserGuid = new Guid("a3f3d2d0-5fe6-4c64-8084-50dc34888741"),
                            CreatedDate = new DateTime(2021, 7, 17, 22, 35, 13, 623, DateTimeKind.Local).AddTicks(2519),
                            EditedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Admin",
                            IsActive = true,
                            LastName = "User",
