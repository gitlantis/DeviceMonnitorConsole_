...
namespace DeviceMonnitorAPI.Migrations
{
    ...
    [Migration("20210719185442_Migration07")]
            ...
            modelBuilder.Entity("DeviceMonnitorAPI.DBModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserGuid = new Guid("ec3349a8-0bc7-4ed1-bb36-ba6f6597cc0c"),
                            CreatedDate = new DateTime(2021, 7, 19, 23, 54, 41, 909, DateTimeKind.Local).AddTicks(2650),
                        ...
                        new
                        {
                            UserGuid = new Guid("07d307c4-93b3-47d2-90a5-78603ade05d6"),
                            CreatedDate = new DateTime(2021, 7, 19, 23, 54, 41, 909, DateTimeKind.Local).AddTicks(3034),
                            EditedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Admin",
                            IsActive = true,
                            LastName = "User",
