...
namespace DeviceMonnitorAPI.Migrations
{
    ...
    [Migration("20210724080820_Migration08")]
            ...
            modelBuilder.Entity("DeviceMonnitorAPI.DBModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserGuid = new Guid("a5e2e290-c48a-4806-bc48-f93022106440"),
                            CreatedDate = new DateTime(2021, 7, 24, 13, 8, 20, 91, DateTimeKind.Local).AddTicks(8344),
                        ...
                        new
                        {
                            UserGuid = new Guid("02b64295-2ed0-4dd5-bb56-0978733660b7"),
                            CreatedDate = new DateTime(2021, 7, 24, 13, 8, 20, 91, DateTimeKind.Local).AddTicks(8762),
                            EditedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Admin",
                            IsActive = true,
                            LastName = "User",
